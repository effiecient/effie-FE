...
import { NewFolder, NewLink } from "@/components";
type LinkCardProps = {
    content:
        | "new folder"
        | "new link"
...
export default function LinkCard({
    ...
    const [isNewLinkModalOpened, setIsNewLinkModalOpened] =
        useState<boolean>(false);
    const [isNewFolderModalOpened, setIsNewFolderModalOpened] =
        useState<boolean>(false);
    ...
    return (
        <>
                    ...
                    <>
                        ...
                        >
                            <Image
                                ...
                                height={28}
                            />
                            <h6 className="text-primary-500 ml-2">
                                New folder
                            </h6>
                        </div>
                    </>
            ...
            {/* modal */}
            <NewLink
                isOpen={isNewLinkModalOpened}
                onClose={() => setIsNewLinkModalOpened(false)}
            />
            <NewFolder
                isOpen={isNewFolderModalOpened}
                onClose={() => setIsNewFolderModalOpened(false)}
            />
        </>
    );
}
