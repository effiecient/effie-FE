    ...
    return (
        <>
            ...
            >
                ...
                {/* BROWSER CONTENT*/}
                <div className="sticky top-16 p-8 w-full bg-neutral-50 z-0 flex flex-col gap-6 flex-grow lg:rounded-t-2xl">
                    <Background />
                    {/* BACKGROUND */}
                    {/* BREADCRUMBS */}
                    <div className="sticky top-24 flex py-4 justify-between">
                        <BrowserBreadcrumb />
                        <button
                            onClick={() => {
