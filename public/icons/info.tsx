...
export default function InfoIcon({ className } : InfoIconProps) {
    return (
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        	 viewBox="0 0 24 24" className={className} xmlSpace="preserve">
        <g id="bounding_area">
        	<rect fill="none" width="24" height="24"/>
        </g>
        <g id="design">
        	<g>
        		<path className="fill-neutral-400" d="M12,17c-0.41,0-0.75-0.34-0.75-0.75v-5c0-0.41,0.34-0.75,0.75-0.75s0.75,0.34,0.75,0.75v5
        			C12.75,16.66,12.41,17,12,17z" />
        		<path className="fill-neutral-400" d="M12,9c-0.26,0-0.52-0.11-0.71-0.29c-0.09-0.1-0.16-0.2-0.21-0.33C11.03,8.26,11,8.13,11,8
        		...
        		<path className="fill-neutral-400" d="M11.99,22c-2.58,0-5.02-0.97-6.89-2.76c-1.93-1.84-3.03-4.33-3.1-7S2.92,7.04,4.76,5.1
